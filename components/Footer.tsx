          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:text-[#014034] hover:border-[#014034] transition-all">
                  <Icon size={18} />
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-600">{SITE_SETTINGS.address}</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="text-[#00695c] w-5 h-5 shrink-0" />
                <span className="text-gray-600">{SITE_SETTINGS.phone}</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="text-[#00695c] w-5 h-5 shrink-0" />
                <span className="text-gray-600">{SITE_SETTINGS.email}</span>
              </li>
            </ul>
          </div>
        </div>
